...
public:
  ...
  void SetRequestDataSize (uint32_t requestDataSize);
  uint32_t GetRequestDataSize (void) const;
  ...
  void SetFlowInfoStream (Ptr<OutputStreamWrapper> streamWrapper);
...
private:
  ...
  Ptr<OutputStreamWrapper> m_flowInfoStream;
